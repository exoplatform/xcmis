...
import org.xcmis.gwtframework.client.model.property.CmisProperty;
...
public class GwtTestNavigationService extends GWTTestCase
{
   ...
   private String childrenResponse =
      "<?xml version=\"1.0\" ?>"
         ...
         + "<cmis:canGetDescendants>true</cmis:canGetDescendants>" + "<cmis:canMoveObject>true</cmis:canMoveObject>"
         + "<cmis:canDeleteContentStream>false</cmis:canDeleteContentStream>"
         ...
         + "<cmis:canApplyPolicy>true</cmis:canApplyPolicy>"
         + "<cmis:canGetAppliedPolicies>true</cmis:canGetAppliedPolicies>"
         + "<cmis:canRemovePolicy>true</cmis:canRemovePolicy>" + "<cmis:canGetChildren>true</cmis:canGetChildren>"
         + "<cmis:canCreateDocument>true</cmis:canCreateDocument>"
         + "<cmis:canCreateFolder>true</cmis:canCreateFolder>"
         + "<cmis:canCreateRelationship>true</cmis:canCreateRelationship>"
         + "<cmis:canDeleteTree>true</cmis:canDeleteTree>" + "<cmis:canGetRenditions>false</cmis:canGetRenditions>"
         + "<cmis:canGetACL>true</cmis:canGetACL>" + "<cmis:canApplyACL>true</cmis:canApplyACL>"
         + "</cmis:allowableActions>" + "</cmisra:object>" + "</entry>" + "</feed>";

   private String descendantsResponse =
      "<?xml version=\"1.0\" ?>"
         ...
         + "<cmis:propertyId propertyDefinitionId=\"cmis:allowedChildObjectTypeIds\" localName=\"cmis:allowedChildObjectTypeIds\"></cmis:propertyId>"
         + "<cmis:propertyDateTime propertyDefinitionId=\"cmis:lastModificationDate\" localName=\"cmis:lastModificationDate\">"
         + "<cmis:value>2010-03-10T14:52:27.953Z</cmis:value>" + "</cmis:propertyDateTime>"
         + "<cmis:propertyId propertyDefinitionId=\"cmis:objectId\" localName=\"cmis:objectId\">"
         + "<cmis:value>48221eb1c0a8001d002236a9b68d39f7</cmis:value>" + "</cmis:propertyId>"
         + "<cmis:propertyString propertyDefinitionId=\"cmis:createdBy\" localName=\"cmis:createdBy\">"
         + "<cmis:value>__anonim</cmis:value>" + "</cmis:propertyString>"
         + "<cmis:propertyDateTime propertyDefinitionId=\"cmis:creationDate\" localName=\"cmis:creationDate\">"
         + "<cmis:value>2010-03-10T14:52:27.953Z</cmis:value>" + "</cmis:propertyDateTime>"
         + "<cmis:propertyString propertyDefinitionId=\"cmis:name\" localName=\"cmis:name\">"
         + "<cmis:value>13</cmis:value>" + "</cmis:propertyString>"
         + "<cmis:propertyId propertyDefinitionId=\"cmis:baseTypeId\" localName=\"cmis:baseTypeId\">"
         + "<cmis:value>cmis:folder</cmis:value>" + "</cmis:propertyId>"
         + "<cmis:propertyString propertyDefinitionId=\"cmis:lastModifiedBy\" localName=\"cmis:lastModifiedBy\">"
         + "<cmis:value>__anonim</cmis:value>" + "</cmis:propertyString>" + "</cmis:properties>" + "</cmisra:object>"
         + "<cmisra:pathSegment>13</cmisra:pathSegment>" + "</entry>" + "</feed>"
         + "<cmisra:numItems>2</cmisra:numItems>" + "</cmisra:children>" + "</entry>" + "</feed>";
   ...
   public void testGetChildren()
   {
      ...
      List<CmisProperty> properties = entry.getObject().getProperties().getProperty();
      assertEquals(10, properties.size());
      assertEquals("cmis:changeToken", properties.get(0).getPropertyDefinitionId());
      assertEquals("48091ca7c0a8001d01df1f78a46b9a6d", ((CmisPropertyString)properties.get(0)).getValue().get(0));

      assertEquals("cmis:objectTypeId", properties.get(1).getPropertyDefinitionId());
      assertEquals("cmis:policy", ((CmisPropertyId)properties.get(1)).getValue().get(0));

      assertEquals("cmis:policyText", properties.get(2).getPropertyDefinitionId());
      assertEquals("some policy text", ((CmisPropertyString)properties.get(2)).getValue().get(0));

      assertEquals("cmis:objectId", properties.get(4).getPropertyDefinitionId());
      assertEquals("48091ca7c0a8001d0059cab8ec875af9", ((CmisPropertyId)properties.get(4)).getValue().get(0));

      assertEquals("cmis:createdBy", properties.get(5).getPropertyDefinitionId());
      assertEquals("__anonim", ((CmisPropertyString)properties.get(5)).getValue().get(0));

      assertEquals("cmis:name", properties.get(7).getPropertyDefinitionId());
      assertEquals("policy1", ((CmisPropertyString)properties.get(7)).getValue().get(0));

      assertEquals("cmis:baseTypeId", properties.get(8).getPropertyDefinitionId());
      assertEquals("cmis:policy", ((CmisPropertyId)properties.get(8)).getValue().get(0));

      assertEquals("cmis:lastModifiedBy", properties.get(9).getPropertyDefinitionId());
      assertEquals("__anonim", ((CmisPropertyString)properties.get(9)).getValue().get(0));

      entry = entryList.get(1);
      assertEquals(6, entry.getEntryInfo().getLinks().size());
      assertEquals(12, entry.getObject().getProperties().getProperty().size());

      assertTrue(entry.getObject().getAllowableActions().isCanDeleteObject());
      assertTrue(entry.getObject().getAllowableActions().isCanUpdateProperties());
      ...
      assertTrue(entry.getObject().getAllowableActions().isCanGetObjectRelationships());
      assertTrue(entry.getObject().getAllowableActions().isCanGetObjectParents());
      assertTrue(entry.getObject().getAllowableActions().isCanGetFolderParent());
      assertTrue(entry.getObject().getAllowableActions().isCanGetDescendants());
      assertFalse(entry.getObject().getAllowableActions().isCanDeleteContentStream());
      ...
      assertFalse(entry.getObject().getAllowableActions().isCanGetAllVersions());
      assertFalse(entry.getObject().getAllowableActions().isCanAddObjectToFolder());
      assertFalse(entry.getObject().getAllowableActions().isCanRemoveObjectFromFolder());
      assertFalse(entry.getObject().getAllowableActions().isCanGetContentStream());

      assertTrue(entry.getObject().getAllowableActions().isCanApplyPolicy());
      assertTrue(entry.getObject().getAllowableActions().isCanGetAppliedPolicies());
      assertTrue(entry.getObject().getAllowableActions().isCanRemovePolicy());
      assertTrue(entry.getObject().getAllowableActions().isCanCreateDocument());
      assertTrue(entry.getObject().getAllowableActions().isCanCreateFolder());
      assertTrue(entry.getObject().getAllowableActions().isCanCreateRelationship());
   ...
   public void testGetDescendants()
   {
      ...
      assertEquals("48220bb5c0a8001d012f8e6ccc129f0b", child1.getEntryInfo().getId());
      assertEquals(12, child1.getObject().getProperties().getProperty().size());
      assertEquals("cmis:parentId", child1.getObject().getProperties().getProperty().get(0).getPropertyDefinitionId());
      ...
      assertEquals("4822469bc0a8001d009d8ece43ad7742", subchild1.getEntryInfo().getId());
      assertEquals(12, subchild1.getObject().getProperties().getProperty().size());
      assertEquals("cmis:path", subchild1.getObject().getProperties().getProperty().get(1).getPropertyDefinitionId());
      ...
      assertEquals("48221eb1c0a8001d002236a9b68d39f7", child2.getEntryInfo().getId());
      assertEquals(12, child2.getObject().getProperties().getProperty().size());
      assertEquals("cmis:changeToken", child2.getObject().getProperties().getProperty().get(2).getPropertyDefinitionId());
   }
}
