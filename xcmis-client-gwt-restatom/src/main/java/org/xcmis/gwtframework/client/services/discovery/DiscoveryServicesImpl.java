...
import org.xcmis.gwtframework.client.services.discovery.event.QueryResultReceivedEvent;
 ...
 *
 */
public class DiscoveryServicesImpl extends DiscoveryServices
{
    ...
    */
   public DiscoveryServicesImpl(HandlerManager eventBus)
   {
      this.eventBus = eventBus;
   }
   
   /**
    * @see org.xcmis.gwtframework.client.services.discovery.DiscoveryServices#query(
    * java.lang.String, org.xcmis.gwtframework.client.model.actions.Query)
    * 
    * @param url url
    * @param query query
    */
