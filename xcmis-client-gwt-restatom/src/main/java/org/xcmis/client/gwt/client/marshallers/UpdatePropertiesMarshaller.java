 ...
 * @version $Id:
 */
public class UpdatePropertiesMarshaller implements Marshallable
{
   
   /**
    * Data for updating object's properties.
    */
    ...
    */
   public UpdatePropertiesMarshaller(UpdateProperties updateProperties)
   {
   ...
   {
      return ObjectXMLBuilder.updateProperties(updateProperties);
   }
}
