...
public class DateTimeProperty extends BaseProperty<Date>
{
    ...
    * @param value value
    */
   public DateTimeProperty(String id, String queryName, String localName, String displayName, Date value)
   {
    ...
    * @param values values
    */
   public DateTimeProperty(String id, String queryName, String localName, String displayName, List<Date> values)
   {
