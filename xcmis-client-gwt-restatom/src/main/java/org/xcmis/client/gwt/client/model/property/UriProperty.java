 ...
 * @version $Id: $
 */
public class UriProperty extends BaseProperty<String>
{
    ...
    * @param value value
    */
   public UriProperty(String id, String queryName, String localName, String displayName, String value)
   {
    ...
    * @param values values
    */
   public UriProperty(String id, String queryName, String localName, String displayName, List<String> values)
   {
