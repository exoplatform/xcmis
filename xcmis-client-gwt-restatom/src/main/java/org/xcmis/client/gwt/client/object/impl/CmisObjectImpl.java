...
import org.xcmis.client.gwt.client.model.Rendition;
...
public class CmisObjectImpl implements CmisObject 
{
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#getACL()
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#getAllowableActions()
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#getChangeInfo()
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#getObjectInfo()
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#getPathSegment()
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#getPolicyIds()
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#getProperties()
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#setProperties(org.xcmis.client.gwt.client.model.property.CmisProperties)
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#getRelationship()
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#getRenditions()
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#isExactACL()
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#setAllowableActions(org.xcmis.client.gwt.client.model.AllowableActions)
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#setChangeInfo(org.xcmis.client.gwt.client.object.impl.ChangeInfo)
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#setObjectInfo(org.xcmis.client.gwt.client.object.impl.ObjectInfo)
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#setExactACL(boolean)
    */
   ...
   /**
    * @see org.xcmis.client.gwt.client.object.CmisObject#setPathSegment(java.lang.String)
    */
