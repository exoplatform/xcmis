 ...
 * @version $Id: $
 */
public class UriPropertyDefinition extends BasePropertyDefinition<String>
{

   /**
    * Default constructor.
    */
   public UriPropertyDefinition()
   {
      super();
   }
    ...
    */
   public UriPropertyDefinition(String id, String localName, String localNamespace,
