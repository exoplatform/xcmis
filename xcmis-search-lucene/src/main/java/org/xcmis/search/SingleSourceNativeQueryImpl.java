...
public class SingleSourceNativeQueryImpl<Q> implements SingleSourceNativeQuery<Q>
{
    ...
    * {@inheritDoc}
    */
   public List<ScoredRow> filter(final List<ScoredRow> results) throws IOException, RepositoryException
   {
    ...
    * {@inheritDoc}
    */
   public List<ScoredRow> sort(final List<ScoredRow> results) throws IOException, InvalidQueryException
   {
      if (postSorter != null)
      {
