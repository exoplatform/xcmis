...
public class LoggedIndexTransactionImpl extends LuceneIndexTransaction implements LoggedIndexTransaction<Document>
{
   ...
   {
      super(indexTransaction.getAddedDocuments(), indexTransaction.getUpdatedDocuments(), indexTransaction
         .getRemovedDocuments());
    ...
    * @param deletedDocuments
    */
   public LoggedIndexTransactionImpl(final Map<String, Document> addedDocuments,
   ...
   {
      super(addedDocuments, updatedDocuments, deletedDocuments);
      this.transactionLog =
         new FileSystemTransactionLog(addedDocuments.keySet(), updatedDocuments.keySet(), deletedDocuments,
