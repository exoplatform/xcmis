 ...
 * @version $Id: GreaterThanOperatorVisitor.java 2 2010-02-04 17:21:49Z andrew00x $
 */
public class GreaterThanOperatorVisitor extends OperatorVisitor
{
   /**
    * Class logger.
    */
    ...
    */
   public GreaterThanOperatorVisitor(final Value staticOperandValue, final LocationFactory locationFactory)
   {
   ...
   public Object visit(final LengthImpl node, final Object context) throws Exception
   {
      ...
      return new RangeQuery(
         new Term(FieldNames.createFieldLengthName(node.getPropertyValue().getPropertyName()), value), null, false);
   }
   ...
   public Object visit(final NodeNameImpl node, final Object context) throws Exception
   {
      ...
      {
         result = new CaseInsensitiveRangeQuery(new Term(FieldNames.LABEL, staticStingValue), null, false);

      }
      else
      {

         result = new RangeQuery(new Term(FieldNames.LABEL, staticStingValue), null, false);
      }
      return result;
   }
      ...
      if (this.caseInsensitiveSearch)
      {
         result =
            new CaseInsensitiveRangeQuery(new Term(FieldNames.createPropertyFieldName(node.getPropertyName()),
               ...
               new Term(FieldNames.createPropertyFieldName(node.getPropertyName()), "\uFFFF"), false);
         ...
         result =
            new RangeQuery(
               new Term(FieldNames.createPropertyFieldName(node.getPropertyName()), getStaticOperandValue()), new Term(
                  FieldNames.createPropertyFieldName(node.getPropertyName()), "\uFFFF"), false);
      }
      return result;
