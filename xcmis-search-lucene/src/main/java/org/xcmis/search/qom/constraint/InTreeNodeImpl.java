 ...
 * @version $Id: InTreeNodeImpl.java 2 2010-02-04 17:21:49Z andrew00x $
 */
public class InTreeNodeImpl extends ConstraintImpl implements InTreeNode
{
   /**
    * Class logger.
    */
    ...
    */
   public InTreeNodeImpl(LocationFactory locationFactory, InternalQName selectorName, String folderId)
   {
