 ...
 * @version $Id: FullTextSearchScoreImpl.java 2 2010-02-04 17:21:49Z andrew00x $
 */
public class FullTextSearchScoreImpl extends DynamicOperandImpl implements FullTextSearchScore
{
    ...
    */
   public FullTextSearchScoreImpl(LocationFactory locationFactory, InternalQName selectorName)
   {
