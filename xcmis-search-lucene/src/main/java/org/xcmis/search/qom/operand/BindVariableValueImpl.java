 ...
 * @version $Id: BindVariableValueImpl.java 2 2010-02-04 17:21:49Z andrew00x $
 */
public class BindVariableValueImpl extends StaticOperandImpl implements BindVariableValue
{
    ...
    */
   private final InternalQName bindVariableName;
   ...
   /**
    * @param bindVariableName - Name of the bind variable.
    */
   public BindVariableValueImpl(LocationFactory locationFactory, InternalQName bindVariableName)
   {
   ...
   {
      return getJCRName(bindVariableName);
   }
   ...
   {
      return "bindVariableName=" + bindVariableName;
   }
}
