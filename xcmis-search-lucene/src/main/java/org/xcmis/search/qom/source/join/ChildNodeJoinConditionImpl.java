 ...
 * @version $Id: ChildNodeJoinConditionImpl.java 2 2010-02-04 17:21:49Z andrew00x $
 */
public class ChildNodeJoinConditionImpl extends JoinConditionImpl implements ChildNodeJoinCondition
{
   /**
    * Name of the child selector.
    */
   private final InternalQName childSelectorName;
    ...
    */
   private final InternalQName parentSelectorName;

   /**
    * @param childSelectorName - Name of the child selector.
    * @param parentSelectorName - Name of the parent selector.
    */
   public ChildNodeJoinConditionImpl(LocationFactory locationFactory, InternalQName childSelectorName,
      InternalQName parentSelectorName)
   {
   ...
   {
      return getParentSelectorName() + "=" + getChildSelectorName();
   }
}
