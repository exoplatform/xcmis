 ...
 * @version $Id: UpperCaseImpl.java 2 2010-02-04 17:21:49Z andrew00x $
 */
public class UpperCaseImpl extends DynamicOperandImpl implements UpperCase
{
   ...
   /**
    * @param operand - The operand whose value is converted to a upper-case string.
    */
   public UpperCaseImpl(LocationFactory locationFactory, DynamicOperand operand)
   {
