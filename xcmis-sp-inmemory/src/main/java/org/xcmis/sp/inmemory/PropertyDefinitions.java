...
public final class PropertyDefinitions
{
   ...
   static
   {
      ...
      {
         // Common properties.
         put(objectType.value(), createPropertyDefinition(CmisConstants.BASE_TYPE_ID, PropertyType.ID,
         ...
         put(objectType.value(), createPropertyDefinition(CmisConstants.NAME, PropertyType.STRING, CmisConstants.NAME,
            CmisConstants.NAME, null, CmisConstants.NAME, true, false, false, false, false, Updatability.READWRITE,
            "Object name.", true, null, null));

         put(objectType.value(), createPropertyDefinition(CmisConstants.CREATED_BY, PropertyType.STRING,
         ...
         put(objectType.value(), createPropertyDefinition(CmisConstants.LAST_MODIFICATION_DATE, PropertyType.DATETIME,
         ...
         put(objectType.value(), createPropertyDefinition(CmisConstants.CHANGE_TOKEN, PropertyType.STRING,
         ...
         if (objectType == BaseType.DOCUMENT)
         {
            ...
            put(objectType.value(), createPropertyDefinition(CmisConstants.IS_LATEST_MAJOR_VERSION,
            ...
            put(objectType.value(), createPropertyDefinition(CmisConstants.IS_VERSION_SERIES_CHECKED_OUT,
            ...
            put(objectType.value(), createPropertyDefinition(CmisConstants.VERSION_SERIES_CHECKED_OUT_BY,
            ...
            put(objectType.value(), createPropertyDefinition(CmisConstants.VERSION_SERIES_CHECKED_OUT_ID,
            ...
            put(objectType.value(), createPropertyDefinition(CmisConstants.CONTENT_STREAM_MIME_TYPE,
            ...
            put(objectType.value(), createPropertyDefinition(CmisConstants.CONTENT_STREAM_FILE_NAME,
         ...
         {
            put(objectType.value(), createPropertyDefinition(CmisConstants.PARENT_ID, PropertyType.ID,
            ...
            put(objectType.value(), createPropertyDefinition(CmisConstants.ALLOWED_CHILD_OBJECT_TYPE_IDS,
            ...
            put(objectType.value(), createPropertyDefinition(CmisConstants.PATH, PropertyType.STRING,
