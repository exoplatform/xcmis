...
"gadgets.iframeBaseUri" : "/xcmis/gadgets/ifr",

// jsUriTemplate will have %host% and %js% substituted.
// No locked domain special cases, but jsUriTemplate must
// never conflict with a lockedDomainSuffix.
"gadgets.jsUriTemplate" : "http://%host%/xcmis/gadgets/js/%js%",

// Callback URL.  Scheme relative URL for easy switch between https/http.
"gadgets.oauthGadgetCallbackTemplate" : "//%host%/xcmis/gadgets/oauthcallback",
...
"gadgets.features" : {
  "core.io" : {
    ...
    "proxyUrl" : "http://%host%/xcmis/gadgets/proxy?refresh=%refresh%&url=%url%%rewriteMime%",
    "jsonProxyUrl" : "http://%host%/xcmis/gadgets/makeRequest"
  },
  "views" : {
    "profile" : {
      "isOnlyVisible" : false,
      "urlTemplate" : "http://%host%/xcmis/gadgets/profile?{var}",
      "aliases": ["DASHBOARD", "default"]
    },
    "canvas" : {
      "isOnlyVisible" : true,
      "urlTemplate" : "http://%host%/xcmis/gadgets/canvas?{var}",
      "aliases" : ["FULL_PAGE"]
    }
  },
  "rpc" : {
