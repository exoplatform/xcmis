...
import org.xcmis.search.query.QueryResults.Columns;
...
public class QueryResultColumns implements Columns
{
   ...
   public QueryResultColumns(List<Column> columns, boolean includeFullTextSearchScores)
   {
      ...
      Validate.notNull(columns, "The columns argument may not be null");
   }
   ...
   public static boolean includeFullTextScores(Iterable<Constraint> constraints)
   {
      ...
      {
         if (includeFullTextScores(constraint))
         {
            return true;
         }
      }
   ...
   public static boolean includeFullTextScores(Constraint constraint)
   {
      ...
      if (constraint != null)
      {
         try
         {
            Visitors.visitAll(constraint, new Visitors.AbstractModelVisitor()
            {
               @Override
   ...
   {
      if (locationIndexByColumnIndex.isEmpty())
      {
         return 0;
      }
      ...
      if (result == null)
      {
         throw new IndexOutOfBoundsException("Column '" + columnIndex + "' does not exist in query");
      }
   ...
   {
      if (locationIndexByColumnName.isEmpty())
      {
         return 0;
      }
      ...
      if (result == null)
      {
         throw new NoSuchElementException("Column '" + columnName + "' does not exist in query");
      }
      return result.intValue();
   }
   ...
   public int getLocationIndex(String selectorName)
   {
      ...
      if (result == null)
      {
         throw new NoSuchElementException("Selector '" + selectorName + "' does not exist in query");
      }
      return result.intValue();
   }
   ...
   public int getColumnIndexForProperty(String selectorName, String propertyName)
   {
      ...
      if (result == null)
      {
         throw new NoSuchElementException("Property '" + propertyName + "' on selector '" + selectorName
