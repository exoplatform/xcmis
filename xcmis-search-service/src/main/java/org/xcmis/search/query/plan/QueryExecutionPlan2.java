 ...
 */
@Deprecated
public class QueryExecutionPlan2 extends LinkedList<QueryExecutionPlan>
{
    ...
    */
   public Iterator<QueryExecutionPlan> iterator()
   {
    ...
    */
   public QueryExecutionPlan findStep(QueryExecutionPlan.Type type)
   {
      Iterator<QueryExecutionPlan> iterator = super.iterator();
      while (iterator.hasNext())
      {
         QueryExecutionPlan queryExecutionStep = iterator.next();
