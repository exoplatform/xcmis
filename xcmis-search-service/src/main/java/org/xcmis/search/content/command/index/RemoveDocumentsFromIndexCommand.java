...
/**
 * Remove List of documents from index.
 */
public class RemoveDocumentsFromIndexCommand implements VisitableCommand
{
   ...
   {
      return visitor.visitRemoveDocumentsFromIndexCommand(ctx, this);
   }
