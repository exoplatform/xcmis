...
public class FileSystemTransactionLog implements TransactionLog
{
   ...
   private Set<String> updatedDocumentsUuids; // =
      ...
      throws TransactionLogException
   {
      ...
      //
      // this.updatedDocumentsUuids = new HashSet<String>();
    ...
    */
   public FileSystemTransactionLog(final Set<String> addedDocumentsUuids, final Set<String> updatedDocumentsUuids,
      final Set<String> removedDocumentsUuids, final FSIndexTransactionService storage)
   {
      ...
      this.updatedDocumentsUuids = updatedDocumentsUuids;
   ...
   {
      if (this.updatedDocumentsUuids == null)
      {
         this.load();
      }
      return this.updatedDocumentsUuids;
   }
         ...
         while ((type = in.read()) != -1)
         {
            ...
            switch (type)
            {
               case ADDED_DOCUMENTS :
                  this.updatedDocumentsUuids.add(uuid);
                  break;
               case UPDATED_DOCUMENTS :
                  this.updatedDocumentsUuids.add(uuid);
                  break;
   ...
   public void log() throws TransactionLogException
   {
      ...
      try
      {
         //TODO fix buildPathFromName to get UUID
         final String fileName = StringUtils.remove(UUID.randomUUID().toString(), "-");
         ...
         this.writeSet(out, this.updatedDocumentsUuids, FileSystemTransactionLog.UPDATED_DOCUMENTS);
