 ...
 * @version $Id: MultiSourceNativeQueryImpl.java 2 2010-02-04 17:21:49Z andrew00x $
 */
public class MultiSourceNativeQueryImpl<Q> implements MultiSourceNativaQuery<Q>
{
    ...
    * {@inheritDoc}
    */
   public List<ScoredRow> search(final SearchIndexingService<Q> indexSearcher) throws IOException, SearchServiceException
   {
