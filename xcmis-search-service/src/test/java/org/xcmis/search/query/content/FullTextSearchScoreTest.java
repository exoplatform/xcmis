...
public class FullTextSearchScoreTest extends AbstractQOMTest
{
   ...
   //         qf.createQuery(qf.selector(testNodeType, "s"), qf.and(qf.fullTextSearch("s", null, qf.literal(vf
   //            .createValue("fox"))), qf.descendantNode("s", testRootNode.getPath())), new Ordering[]{qf.ascending(qf
   //            .fullTextSearchScore("s"))}, null);
   ...
   //   {
   //      QueryObjectModel qom =
   //         qf.createQuery(qf.selector(testNodeType, "s"), qf.and(qf.and(qf.fullTextSearch("s", null, qf.literal(vf
   //            .createValue("fox"))), qf.comparison(qf.fullTextSearchScore("s"),
   //            QueryObjectModelFactory.JCR_OPERATOR_GREATER_THAN, qf.literal(vf.createValue(Double.MIN_VALUE)))), qf
   //            .descendantNode("s", testRootNode.getPath())), new Ordering[]{qf.descending(qf.fullTextSearchScore("s"))},
   //            null);
   //      forQOMandSQL2(qom, new Callable()
   //      {
   //         public Object call(Query query) throws RepositoryException
