...
public class CMISExtensionFactory extends AbstractExtensionFactory
{
   ...
   public CMISExtensionFactory()
   {
      ...
      addImpl(AtomCMIS.PROPERTY_BOOLEAN_DEFINITION, PropertyBooleanDefinitionTypeElement.class);
      addImpl(AtomCMIS.PROPERTY_DATE_TIME_DEFINITION, PropertyDateTimeDefinitionTypeElement.class);
      addImpl(AtomCMIS.PROPERTY_DECIMAL_DEFINITION, PropertyDecimalDefinitionTypeElement.class);
      addImpl(AtomCMIS.PROPERTY_HTML_DEFINITION, PropertyHtmlDefinitionTypeElement.class);
      addImpl(AtomCMIS.PROPERTY_ID_DEFINITION, PropertyIdDefinitionTypeElement.class);
      addImpl(AtomCMIS.PROPERTY_INTEGER_DEFINITION, PropertyIntegerDefinitionTypeElement.class);
      addImpl(AtomCMIS.PROPERTY_STRING_DEFINITION, PropertyStringDefinitionTypeElement.class);
      addImpl(AtomCMIS.PROPERTY_URI_DEFINITION, PropertyUriDefinitionTypeElement.class);
      ...
      classes2QName.put(CmisPropertyBooleanDefinitionType.class, AtomCMIS.PROPERTY_BOOLEAN_DEFINITION);
      classes2QName.put(CmisPropertyDateTimeDefinitionType.class, AtomCMIS.PROPERTY_DATE_TIME_DEFINITION);
      classes2QName.put(CmisPropertyDecimalDefinitionType.class, AtomCMIS.PROPERTY_DECIMAL_DEFINITION);
      classes2QName.put(CmisPropertyHtmlDefinitionType.class, AtomCMIS.PROPERTY_HTML_DEFINITION);
      classes2QName.put(CmisPropertyIdDefinitionType.class, AtomCMIS.PROPERTY_ID_DEFINITION);
      classes2QName.put(CmisPropertyIntegerDefinitionType.class, AtomCMIS.PROPERTY_INTEGER_DEFINITION);
      classes2QName.put(CmisPropertyStringDefinitionType.class, AtomCMIS.PROPERTY_STRING_DEFINITION);
      classes2QName.put(CmisPropertyUriDefinitionType.class, AtomCMIS.PROPERTY_URI_DEFINITION);
