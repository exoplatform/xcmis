 ...
 * Fri Apr 16 16:05:51 EEST 2010
 * Generated source version: 2.1.4
 * 
 */

public final class ObjectServicePort_ObjectServicePort_Client
{

   private static final QName SERVICE_NAME =
      new QName("http://docs.oasis-open.org/ns/cmis/ws/200908/", "ObjectService");

   private ObjectServicePort_ObjectServicePort_Client()
   {
   }
   ...
   public static void main(String args[]) throws Exception
   {
      ...
      ObjectServicePort port = ss.getObjectServicePort();
...

      {
         ...
         try
         {
            ...
            List<CmisProperty> listProps =_getObject__return.getProperties().getProperty();
            for (CmisProperty cmisProperty : listProps)
            {
               System.out
                  .println(">>> alexey: ObjectServicePort_ObjectServicePort_Client.main cmisProperty.getLocalName() = "
                     + cmisProperty.getLocalName());
               System.out
                  .println(">>> alexey: ObjectServicePort_ObjectServicePort_Client.main cmisProperty.getPropertyDefinitionId() = "
      ...
      }
      {
         ...
         //        try {
         //            org.xcmis.soap.client.CmisPropertiesType _getProperties__return = port.getProperties(_getProperties_repositoryId, _getProperties_objectId, _getProperties_filter, _getProperties_extension);
         ...
         //        try {
         //            org.xcmis.soap.client.CmisContentStreamType _getContentStream__return = port.getContentStream(_getContentStream_repositoryId, _getContentStream_objectId, _getContentStream_streamId, _getContentStream_offset, _getContentStream_length, _getContentStream_extension);
         ...
         //        try {
         //            org.xcmis.soap.client.CmisAllowableActionsType _getAllowableActions__return = port.getAllowableActions(_getAllowableActions_repositoryId, _getAllowableActions_objectId, _getAllowableActions_extension);
         ...
         //        javax.xml.ws.Holder<java.lang.String> _deleteContentStream_objectId = new javax.xml.ws.Holder<java.lang.String>(_deleteContentStream_objectIdVal);
         //        java.lang.String _deleteContentStream_changeTokenVal = "";
         //        javax.xml.ws.Holder<java.lang.String> _deleteContentStream_changeToken = new javax.xml.ws.Holder<java.lang.String>(_deleteContentStream_changeTokenVal);
         //        org.xcmis.soap.client.CmisExtensionType _deleteContentStream_extensionVal = null;
         //        javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType> _deleteContentStream_extension = new javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType>(_deleteContentStream_extensionVal);
         //        try {
         //            port.deleteContentStream(_deleteContentStream_repositoryId, _deleteContentStream_objectId, _deleteContentStream_changeToken, _deleteContentStream_extension);
         //
         //            System.out.println("deleteContentStream._deleteContentStream_objectId=" + _deleteContentStream_objectId.value);
         //            System.out.println("deleteContentStream._deleteContentStream_changeToken=" + _deleteContentStream_changeToken.value);
         //            System.out.println("deleteContentStream._deleteContentStream_extension=" + _deleteContentStream_extension.value);
         //        } catch (CmisException e) { 
         //            System.out.println("Expected exception: cmisException has occurred.");
         //            System.out.println(e.toString());
         //        }
         ...
         //        try {
         //            org.xcmis.soap.client.CmisExtensionType _deleteObject__return = port.deleteObject(_deleteObject_repositoryId, _deleteObject_objectId, _deleteObject_allVersions, _deleteObject_extension);
         ...
         //        javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType> _createRelationship_extension = new javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType>(_createRelationship_extensionVal);
         //        javax.xml.ws.Holder<java.lang.String> _createRelationship_objectId = new javax.xml.ws.Holder<java.lang.String>();
         //        try {
         //            port.createRelationship(_createRelationship_repositoryId, _createRelationship_properties, _createRelationship_policies, _createRelationship_addACEs, _createRelationship_removeACEs, _createRelationship_extension, _createRelationship_objectId);
         //
         ...
         //        javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType> _createDocumentFromSource_extension = new javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType>(_createDocumentFromSource_extensionVal);
         //        javax.xml.ws.Holder<java.lang.String> _createDocumentFromSource_objectId = new javax.xml.ws.Holder<java.lang.String>();
         //        try {
         //            port.createDocumentFromSource(_createDocumentFromSource_repositoryId, _createDocumentFromSource_sourceId, _createDocumentFromSource_properties, _createDocumentFromSource_folderId, _createDocumentFromSource_versioningState, _createDocumentFromSource_policies, _createDocumentFromSource_addACEs, _createDocumentFromSource_removeACEs, _createDocumentFromSource_extension, _createDocumentFromSource_objectId);
         //
         //            System.out.println("createDocumentFromSource._createDocumentFromSource_extension=" + _createDocumentFromSource_extension.value);
         //            System.out.println("createDocumentFromSource._createDocumentFromSource_objectId=" + _createDocumentFromSource_objectId.value);
         //        } catch (CmisException e) { 
         //            System.out.println("Expected exception: cmisException has occurred.");
         //            System.out.println(e.toString());
         //        }
         ...
         //        javax.xml.ws.Holder<java.lang.String> _updateProperties_objectId = new javax.xml.ws.Holder<java.lang.String>(_updateProperties_objectIdVal);
         //        java.lang.String _updateProperties_changeTokenVal = "";
         //        javax.xml.ws.Holder<java.lang.String> _updateProperties_changeToken = new javax.xml.ws.Holder<java.lang.String>(_updateProperties_changeTokenVal);
         ...
         //        javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType> _updateProperties_extension = new javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType>(_updateProperties_extensionVal);
         //        try {
         //            port.updateProperties(_updateProperties_repositoryId, _updateProperties_objectId, _updateProperties_changeToken, _updateProperties_properties, _updateProperties_extension);
         //
         ...
         //        javax.xml.ws.Holder<java.lang.String> _moveObject_objectId = new javax.xml.ws.Holder<java.lang.String>(_moveObject_objectIdVal);
         ...
         //        javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType> _moveObject_extension = new javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType>(_moveObject_extensionVal);
         //        try {
         //            port.moveObject(_moveObject_repositoryId, _moveObject_objectId, _moveObject_targetFolderId, _moveObject_sourceFolderId, _moveObject_extension);
         //
         ...
         //        javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType> _createDocument_extension = new javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType>(_createDocument_extensionVal);
         //        javax.xml.ws.Holder<java.lang.String> _createDocument_objectId = new javax.xml.ws.Holder<java.lang.String>();
         //        try {
         //            port.createDocument(_createDocument_repositoryId, _createDocument_properties, _createDocument_folderId, _createDocument_contentStream, _createDocument_versioningState, _createDocument_policies, _createDocument_addACEs, _createDocument_removeACEs, _createDocument_extension, _createDocument_objectId);
         //
         ...
         //        try {
         //            org.xcmis.soap.client.DeleteTreeResponse.FailedToDelete _deleteTree__return = port.deleteTree(_deleteTree_repositoryId, _deleteTree_folderId, _deleteTree_allVersions, _deleteTree_unfileObjects, _deleteTree_continueOnFailure, _deleteTree_extension);
         ...
         //        try {
         //            java.util.List<org.xcmis.soap.client.CmisRenditionType> _getRenditions__return = port.getRenditions(_getRenditions_repositoryId, _getRenditions_objectId, _getRenditions_renditionFilter, _getRenditions_maxItems, _getRenditions_skipCount, _getRenditions_extension);
         ...
         //        try {
         //            org.xcmis.soap.client.CmisObjectType _getObjectByPath__return = port.getObjectByPath(_getObjectByPath_repositoryId, _getObjectByPath_path, _getObjectByPath_filter, _getObjectByPath_includeAllowableActions, _getObjectByPath_includeRelationships, _getObjectByPath_renditionFilter, _getObjectByPath_includePolicyIds, _getObjectByPath_includeACL, _getObjectByPath_extension);
         ...
         //        javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType> _createFolder_extension = new javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType>(_createFolder_extensionVal);
         //        javax.xml.ws.Holder<java.lang.String> _createFolder_objectId = new javax.xml.ws.Holder<java.lang.String>();
         //        try {
         //            port.createFolder(_createFolder_repositoryId, _createFolder_properties, _createFolder_folderId, _createFolder_policies, _createFolder_addACEs, _createFolder_removeACEs, _createFolder_extension, _createFolder_objectId);
         //
         ...
         //        javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType> _createPolicy_extension = new javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType>(_createPolicy_extensionVal);
         //        javax.xml.ws.Holder<java.lang.String> _createPolicy_objectId = new javax.xml.ws.Holder<java.lang.String>();
         //        try {
         //            port.createPolicy(_createPolicy_repositoryId, _createPolicy_properties, _createPolicy_folderId, _createPolicy_policies, _createPolicy_addACEs, _createPolicy_removeACEs, _createPolicy_extension, _createPolicy_objectId);
         //
         ...
         //        javax.xml.ws.Holder<java.lang.String> _setContentStream_objectId = new javax.xml.ws.Holder<java.lang.String>(_setContentStream_objectIdVal);
         //        java.lang.Boolean _setContentStream_overwriteFlag = null;
         //        java.lang.String _setContentStream_changeTokenVal = "";
         //        javax.xml.ws.Holder<java.lang.String> _setContentStream_changeToken = new javax.xml.ws.Holder<java.lang.String>(_setContentStream_changeTokenVal);
         ...
         //        javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType> _setContentStream_extension = new javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType>(_setContentStream_extensionVal);
         //        try {
         //            port.setContentStream(_setContentStream_repositoryId, _setContentStream_objectId, _setContentStream_overwriteFlag, _setContentStream_changeToken, _setContentStream_contentStream, _setContentStream_extension);
         //
