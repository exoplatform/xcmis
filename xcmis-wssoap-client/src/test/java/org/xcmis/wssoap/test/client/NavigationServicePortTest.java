...
public final class NavigationServicePortTest extends TestCase
{

   private static final QName SERVICE_NAME =
      new QName("http://docs.oasis-open.org/ns/cmis/ws/200908/", "NavigationService");

   NavigationServicePort port;
   ...
   protected void setUp() throws Exception
   {
      ...
      port = ss.getNavigationServicePort();
   ...
   public void testGetObjectParents()
   {
      ...
      try
      {
         java.util.List<org.xcmis.soap.client.CmisObjectParentsType> _getObjectParents__return =
            port.getObjectParents(_getObjectParents_repositoryId, _getObjectParents_objectId, _getObjectParents_filter,
   ...
   public void testGetCheckedOutDocs()
   {
      ...
      try
      {
         org.xcmis.soap.client.CmisObjectListType _getCheckedOutDocs__return =
            port.getCheckedOutDocs(_getCheckedOutDocs_repositoryId, _getCheckedOutDocs_folderId,
   ...
   public void testGetDescendants()
   {
      ...
      try
      {
         java.util.List<org.xcmis.soap.client.CmisObjectInFolderContainerType> _getDescendants__return =
            port.getDescendants(_getDescendants_repositoryId, _getDescendants_folderId, _getDescendants_depth,
   ...
   public void testGetFolderTree()
   {
      ...
      try
      {
         java.util.List<org.xcmis.soap.client.CmisObjectInFolderContainerType> _getFolderTree__return =
            port.getFolderTree(_getFolderTree_repositoryId, _getFolderTree_folderId, _getFolderTree_depth,
   ...
   public void testGetChildren()
   {
      ...
      try
      {
         org.xcmis.soap.client.CmisObjectInFolderListType _getChildren__return =
            port.getChildren(_getChildren_repositoryId, _getChildren_folderId, _getChildren_filter,
   ...
   public void testGetFolderParent()
   {
      ...
      try
      {
         org.xcmis.soap.client.CmisObjectType _getFolderParent__return =
            port.getFolderParent(_getFolderParent_repositoryId, _getFolderParent_folderId, _getFolderParent_filter,
