...
/**
 * This class was generated by Apache CXF 2.1.4 Mon Apr 19 15:41:32 EEST 2010
...
public final class VersioningServicePortTest extends BaseTest
{
   ...
   private static final QName VERSIONING_SERVICE_NAME = new QName("http://docs.oasis-open.org/ns/cmis/ws/200908/",
      "VersioningService");
   ...
   public void testCheckIn() throws Exception
   {
      ...
      versioning_port.checkOut(cmisRepositoryId, _checkIn_objectId,
         new javax.xml.ws.Holder<org.xcmis.soap.client.CmisExtensionType>(), new javax.xml.ws.Holder<Boolean>());
   ...
   public void testGetAllVersions() throws Exception
   {
      ...
      CmisPropertiesType properties = object_port.getProperties(cmisRepositoryId, _getAllVersions_objectId, "", null);
      String vsId = null;
      for (CmisProperty p : properties.getProperty())
      {
         if (CmisConstants.VERSION_SERIES_ID.equals(p.getPropertyDefinitionId()))
         {
            vsId = ((CmisPropertyId)p).getValue().get(0);
         }
      }
      ...
      try
      {
         java.util.List<org.xcmis.soap.client.CmisObjectType> _getAllVersions__return =
            versioning_port.getAllVersions(cmisRepositoryId, vsId, _getAllVersions_filter,
   ...
   public void testGetObjectOfLatestVersion() throws Exception
   {
      ...
      CmisPropertiesType properties =
         object_port.getProperties(cmisRepositoryId, _getObjectOfLatestVersion_objectId, "", null);
      String vsId = null;
      for (CmisProperty p : properties.getProperty())
      {
         if (CmisConstants.VERSION_SERIES_ID.equals(p.getPropertyDefinitionId()))
      ...
      try
      {
         org.xcmis.soap.client.CmisObjectType _getObjectOfLatestVersion__return =
            versioning_port.getObjectOfLatestVersion(cmisRepositoryId, vsId, _getObjectOfLatestVersion_major,
               _getObjectOfLatestVersion_filter, _getObjectOfLatestVersion_includeAllowableActions,
               _getObjectOfLatestVersion_includeRelationships, _getObjectOfLatestVersion_renditionFilter,
               _getObjectOfLatestVersion_includePolicyIds, _getObjectOfLatestVersion_includeACL,
               _getObjectOfLatestVersion_extension);
   ...
   public void testCancelCheckOut() throws Exception
   {
      ...
      javax.xml.ws.Holder<java.lang.String> _checkIn_objectId =
         new javax.xml.ws.Holder<java.lang.String>(_cancelCheckOut_objectId);
   ...
   public void testGetPropertiesOfLatestVersion() throws Exception
   {
      ...
      CmisPropertiesType properties =
         object_port.getProperties(cmisRepositoryId, _getPropertiesOfLatestVersion_objectId, "", null);
      String vsId = null;
      for (CmisProperty p : properties.getProperty())
      {
         if (CmisConstants.VERSION_SERIES_ID.equals(p.getPropertyDefinitionId()))
      ...
      try
      {
         org.xcmis.soap.client.CmisPropertiesType _getPropertiesOfLatestVersion__return =
            versioning_port.getPropertiesOfLatestVersion(cmisRepositoryId, vsId, _getPropertiesOfLatestVersion_major,
