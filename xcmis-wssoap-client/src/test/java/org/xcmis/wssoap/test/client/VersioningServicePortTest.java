...
public final class VersioningServicePortTest extends BaseTest
{
   ...
   VersioningServicePort vers_port;
   ...
   public void setUp() throws Exception
   {
      ...
      vers_port = ss.getVersioningServicePort();
      ((BindingProvider)vers_port).getRequestContext().put(BindingProvider.USERNAME_PROPERTY, "root");
      ((BindingProvider)vers_port).getRequestContext().put(BindingProvider.PASSWORD_PROPERTY, "exo");
      super.setUp();
   }
   ...
   public void testCheckOut()
   {
      ...
      java.lang.String _checkOut_repositoryId = cmisRepositoryId;
      java.lang.String _checkOut_objectIdVal = "";
         try {
       _checkOut_objectIdVal = createDocument("test771", rootFolderId);
         } catch (Exception ex){
            fail(ex.getMessage());
         }
      ...
      try
      {
         vers_port.checkOut(_checkOut_repositoryId, _checkOut_objectId, _checkOut_extension, _checkOut_contentCopied);
   ...
   public void testCheckIn()
   {
      ...
      java.lang.String _checkIn_repositoryId = cmisRepositoryId;
      ...
      try
      {
         vers_port.checkIn(_checkIn_repositoryId, _checkIn_objectId, _checkIn_major, _checkIn_properties,
   ...
   public void testGetAllVersions()
   {
      ...
      java.lang.String _getAllVersions_repositoryId = cmisRepositoryId;
      ...
      try
      {
         java.util.List<org.xcmis.soap.client.CmisObjectType> _getAllVersions__return =
            vers_port.getAllVersions(_getAllVersions_repositoryId, _getAllVersions_objectId, _getAllVersions_filter,
   ...
   public void testGetObjectOfLatestVersion()
   {
      System.out.println("Invoking getObjectOfLatestVersion...");
      java.lang.String _getObjectOfLatestVersion_repositoryId = cmisRepositoryId;
      ...
      try
      {
         org.xcmis.soap.client.CmisObjectType _getObjectOfLatestVersion__return =
            vers_port.getObjectOfLatestVersion(_getObjectOfLatestVersion_repositoryId,
               _getObjectOfLatestVersion_objectId, _getObjectOfLatestVersion_major, _getObjectOfLatestVersion_filter,
   ...
   public void testCancelCheckOut()
   {
      ...
      java.lang.String _cancelCheckOut_repositoryId = cmisRepositoryId;
      ...
      try
      {
         org.xcmis.soap.client.CmisExtensionType _cancelCheckOut__return =
            vers_port.cancelCheckOut(_cancelCheckOut_repositoryId, _cancelCheckOut_objectId, _cancelCheckOut_extension);
   ...
   public void testGetPropertiesOfLatestVersion()
   {
      ...
      java.lang.String _getPropertiesOfLatestVersion_repositoryId = cmisRepositoryId;
      ...
      try
      {
         org.xcmis.soap.client.CmisPropertiesType _getPropertiesOfLatestVersion__return =
            vers_port.getPropertiesOfLatestVersion(_getPropertiesOfLatestVersion_repositoryId,
               _getPropertiesOfLatestVersion_objectId, _getPropertiesOfLatestVersion_major,
               _getPropertiesOfLatestVersion_filter, _getPropertiesOfLatestVersion_extension);
