 ...
 * @version $Id: UriPropertyExtractor.java 2 2010-02-04 17:21:49Z andrew00x $
 */
public class UriPropertyExtractor extends AbstractPropertyExtractor implements PropertyExtractor
{
   ...
   public CmisProperty getProperty(Entry cmisEntry, CmisPropertyDefinitionType propDef) throws RepositoryException
   {
      if (EnumCardinality.MULTI == propDef.getCardinality())
      {
         ...
         CmisPropertyUri prop = new CmisPropertyUri();
